...
export default function Registro() {
    ...
    const handleSubmit = async e => {
        ...
        const datos = {
            ...
            trainingLevel: levelRef.current.value,
        ...
        <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
            ...
            <form onSubmit={handleSubmit} noValidate className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                ...
                <div className="mb-4 flex flex-col gap-6">
                    ...
                    <div className="relative h-11 w-full min-w-[200px]">
                        <select name="trainingLevel" id="trainingLevel" ref={levelRef} className="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-hardColor focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
